...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Racket playerRacket;
        int sleepTime;  // sleep time added - Homework Task 02
        ...
        // sleep time added - Homework Task 02
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            this.allObjects.RemoveAll(item => item is Racket);  // remove previous racket - Homework Task 03
            this.staticObjects.RemoveAll(item => item is Racket);   // remove previous racket - Homework Task 03
